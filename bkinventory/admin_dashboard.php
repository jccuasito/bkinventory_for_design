    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="chart-container">
                <h3 class="chart-title">Monthly Quantity Sold</h3> <!-- Added Title -->
            ...
            <!-- Button with Logo -->
            <a href="#" class="button-with-logo" onclick="openChatbot(); return false;">
                <img src="img/chatbot.png" alt="Logo" class="logo-img">
            </a>
...
<script>
    ...
    function openChatbot() {
        ...
        const chatbotWindow = window.open("https://www.chatbase.co/chatbot-iframe/C6CiLZpFPU78i0FLfOSnk", 
                                          "Chatbot Window", 
                                          `width=${width},height=${height},scrollbars=yes,resizable=yes,left=${left},top=${top}`);

        // Attempt to blur the new window
        chatbotWindow.blur();
        window.focus();
    }
</script>
