...
<body>
            ...
            <section id="dashboardContent" class="dashboard-content home-background">
                ...
                <div id="home" class="section active">
                    ...
                    <div id="warningMessage" style="color: red; display: none;">
                        <strong>Not enough stock to buy this product.</strong>
                    </div>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($products_result)): ?>
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $isOutOfStock ? 'out-of-stock' : ''; ?>">
                                    <?php if (!$isOutOfStock): ?>
                                        <select name="quantity[<?php echo $row['product_id']; ?>]" onchange="checkStockAvailability(this, <?php echo $row['product_stock_quantity']; ?>)">
    ...
    <script src="js/cashier_pos.js"></script>
    <script>
    ...
    sidebarToggle.addEventListener('click', () => {
        ...
        function checkStockAvailability(selectElement, availableStock) {
        ...
        if (selectedQuantity > availableStock) {
            ...
            selectElement.value = availableStock; // Reset to max available stock
        } else {
            // Hide warning
            document.getElementById('warningMessage').style.display = 'none';
        }

        calculateTotal(selectElement); // Recalculate the total price after quantity change
        }
